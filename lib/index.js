...
/** 音频文件（随包发布，PlaySync 阻塞播放，wav PCM 兼容 SoundPlayer；可用环境变量覆盖） */
const WAV = {
  ask: process.env.NLW_MAMA_WAV ?? resolve(PACKAGE_ROOT, 'assets', 'mama.wav'),
  ok: process.env.NLW_NIULAI_WAV ?? resolve(PACKAGE_ROOT, 'assets', 'niulai.wav'),
}
